# https://blog.actorsfit.com/a?ID=01100-9986882a-792f-49b2-bc0a-a7ca838133f7
...
class TestDTW:
    ...
    def test_cluster_effect():
        ...
        def d(a, b, l):
            # type: (np.ndarray, np.ndarray, int) -> float
            # print(sum(a.tolist()))
            aa = a.tolist() # What is returned is an iterable object, not a list
            bb = b.tolist()
            # print(aa, type(aa))
            # print(bb, type(bb))
            result_d = 0.0
    ...
    def test_cluster_effect_agg():
        ...
        dbscan = DBSCAN(eps=14,
                        min_samples=2,
                        metric=lambda a, b: DTW.distance(a, b)) # The distance function can be customized
